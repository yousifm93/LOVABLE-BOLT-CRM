...
DROP POLICY IF EXISTS "Users can view their assigned tasks or created tasks" ON public.tasks;
DROP POLICY IF EXISTS "Users can create tasks" ON public.tasks;
DROP POLICY IF EXISTS "Users can update their assigned or created tasks" ON public.tasks;

-- RLS Policies
CREATE POLICY "Users can view their assigned tasks or created tasks" 
ON public.tasks 
FOR SELECT 
