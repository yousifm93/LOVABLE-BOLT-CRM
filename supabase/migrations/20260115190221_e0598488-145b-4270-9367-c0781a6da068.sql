-- Fix execute_extend_rate_lock_automation to remove non-existent pipeline_group column
...
BEGIN
  ...
  IF (TG_OP = 'UPDATE' AND 
    ...
    -- Find active extend rate lock automations (removed non-existent pipeline_group filter)
    FOR automation IN
      SELECT ta.*
