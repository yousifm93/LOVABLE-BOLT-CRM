...
('leads', 'update', 'pipeline', gen_random_uuid(), gen_random_uuid(), now() - interval '1 day 2 hours', '{"status": "Working on it"}', '{"status": "Nurture"}'),
...
-- Insert sample leads for conversion analytics (using correct enum values)
DO $$
DECLARE
...
BEGIN
    ...
    -- Insert sample leads with valid status enum values
    ...
    (sample_account_id, sample_user_id, 'Bob', 'Smith', 'Pending App', CURRENT_DATE, 'bob@email.com', '555-0102'),
    ...
    -- Yesterday's leads
    (sample_account_id, sample_user_id, 'Eve', 'Brown', 'Needs Attention', CURRENT_DATE - 1, 'eve@email.com', '555-0105'),
    ...
    -- Last week's leads
    (sample_account_id, sample_user_id, 'Ivy', 'Jackson', 'Pending App', CURRENT_DATE - 3, 'ivy@email.com', '555-0109'),
    ...
    (sample_account_id, sample_user_id, 'Mia', 'Garcia', 'Needs Attention', CURRENT_DATE - 7, 'mia@email.com', '555-0113');
END $$;