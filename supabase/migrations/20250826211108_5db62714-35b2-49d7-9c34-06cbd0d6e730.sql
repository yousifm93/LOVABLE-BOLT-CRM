-- Fix user ID mismatch and add sample tasks
-- Update the existing user to use the correct authenticated user ID
UPDATE public.users 
SET id = '31e7f1ae-8021-4214-841e-c7d440789fe3'
WHERE email = 'yousif@visionarycapitaltx.com';
