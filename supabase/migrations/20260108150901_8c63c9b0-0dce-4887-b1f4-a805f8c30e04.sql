-- Update the execute_extend_rate_lock_automation function to include disclosure_status = 'Signed' check
...
BEGIN
  -- Only run if:
  -- 1. close_date was updated
  -- 2. disclosure_status = 'Signed'
  -- 3. lock_expiration_date exists
  -- 4. close_date > lock_expiration_date (rate lock is before closing)
