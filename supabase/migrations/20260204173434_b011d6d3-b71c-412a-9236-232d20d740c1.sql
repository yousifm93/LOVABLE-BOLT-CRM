-- Fixed execute_loan_status_changed_automations to use correct leads table column: teammate_assigned
-- Also ensures case-insensitive matching for status transitions
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- FIXED: teammate_assigned is the correct column in leads table
      INSERT INTO tasks (
        borrower_id,
        automation_id,
        title,
