...
export const LOAN_PROGRAM_REQUIREMENTS: Record<string, LoanProgramRequirements> = {
  conventional: {
    ...
    documents: [
      ...
      { docType: 'schedule_f', label: 'Schedule F', description: 'Farm income', required: false },
      { docType: 'k1', label: 'K-1', description: 'Partnership/S-Corp income', required: false, quantity: 2, period: 'years' },
      { docType: 'form_1065', label: 'Form 1065', description: 'Partnership returns (for K-1 adjustments)', required: false, quantity: 2, period: 'years' },
      { docType: 'form_1120s', label: '1120-S', description: 'S-Corporation tax returns', required: false, quantity: 2, period: 'years' },
      { docType: 'form_1120', label: 'Form 1120', description: 'C-Corporation returns (100% ownership)', required: false, quantity: 2, period: 'years' },
  ...
  fha: {
    ...
    documents: [
      ...
      { docType: 'schedule_f', label: 'Schedule F', description: 'Farm income', required: false },
      { docType: 'k1', label: 'K-1', description: 'Partnership/S-Corp income', required: false, quantity: 2, period: 'years' },
      { docType: 'form_1065', label: 'Form 1065', description: 'Partnership returns', required: false, quantity: 2, period: 'years' },
      { docType: 'form_1120s', label: '1120-S', description: 'S-Corporation tax returns', required: false, quantity: 2, period: 'years' },
      { docType: 'form_1120', label: 'Form 1120', description: 'C-Corporation returns (100% ownership)', required: false, quantity: 2, period: 'years' },
    ]
  },
  ...
  jumbo: {
    ...
    documents: [
      ...
      { docType: 'form_1120', label: 'Form 1120', description: 'C-Corporation returns (100% ownership)', required: false },
      { docType: 'voe', label: 'VOE', description: 'Verification of Employment', required: true },
    ]
  },
  non_qm: {
...
export const DOC_TYPE_METADATA: Record<string, { label: string; icon: string; color: string }> = {
  ...
  schedule_b: { label: 'Schedule B', icon: 'FileText', color: 'bg-slate-100 text-slate-800' },
  ...
  form_1120: { label: '1120', icon: 'FileText', color: 'bg-rose-100 text-rose-800' },
