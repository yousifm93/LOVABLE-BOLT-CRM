...
export default function Home() {
  ...
  useEffect(() => {
    const fetchCounts = async () => {
      ...
      // Fetch leads count (new this week)
  ...
  const quickAccessCards: QuickAccessCard[] = [
    { title: "Inbox", icon: Mail, url: "/email", color: "bg-blue-500/10 text-blue-600" },
    ...
    { title: "Real Estate Agents", icon: Phone, url: "/contacts/agents", color: "bg-teal-500/10 text-teal-600" },
